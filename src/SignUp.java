...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("BuddyList");

        jLabel3.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 204, 204));
        jLabel3.setText("copyright @2024 | Kelompok 1 | UPN Veteran Jakarta");

        jLabel9.setFont(new java.awt.Font("Poppins Medium", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("\"Simplify Your Day, One Task at a Time\"");
        ...
        jLabel4.setBackground(new java.awt.Color(65, 109, 109));
        ...
        SignUpBtn.setBackground(new java.awt.Color(65, 109, 109));
        ...
        isAdminCheckBox.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        isAdminCheckBox.setText("Signup as Task Manager");
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
        ...
        SUrl = "jdbc:MySQL://localhost:3306/taskmanagement";
        SUser = "root";
        SPass = "";
        try {
            ...
            query = "INSERT INTO users (full_name, email, password, is_admin) VALUES ('"+fullName+"', '"+email+"' , '"+password+"', "+isAdmin+")";
